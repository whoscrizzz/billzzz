#!/usr/bin/env bash
# Sesión Wrangler, deployments, D1 y smoke HTTP de bills.whoscrizzz.com
set -euo pipefail
...
curl -sI -A "Mozilla/5.0" -o /dev/null -w "bills.whoscrizzz.com/ → %{http_code}\n" https://bills.whoscrizzz.com/ || true
curl -sI -A "Mozilla/5.0" -o /dev/null -w "bills-api/health → %{http_code}\n" https://bills.whoscrizzz.com/bills-api/health || true
